-- Neighbourhood Bank — PostgreSQL schema
-- Run against your Postgres (psql -f schema-postgres.sql, or Neon/Supabase SQL editor).
-- Same tables as schema.sql (D1/SQLite); ids are human-readable strings from nextId().
...
insert into admins (admin_id, telegram_id, name, role, status)
